...
.. |person_icon| image:: img/person_icon.png
    ...
    2. Click **Logout**. If ther Save Session preference is enabled, a progress bar is displayed while your data and windows are saved.

    3. When prompted to log out of all apps, click **Yes** to also log out of all other CyVerse apps or **No** to log out of the DE but stay logged in to other CyVerse apps. 
